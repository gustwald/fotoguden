...
/***/ function(module, exports, __webpack_require__) {
	...
	var _masonryLayout = __webpack_require__(300);

	var _masonryLayout2 = _interopRequireDefault(_masonryLayout);

	var _Intense = __webpack_require__(307);

	var _Intense2 = _interopRequireDefault(_Intense);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var getUrlFromPhoto = function getUrlFromPhoto(photo) {
	...
	$(function () {
	  return;
	  var $collections = $('.collection-wrap');
	  ...
	  if ($collections.length) {
	    $collections.each(function () {
	      ...
	      var addImage = function addImage(_ref) {
	        var photoset = _ref.photoset;

	        photoset.photo.forEach(function (photo) {
	          return $images.append('<img data-imgid="' + photo.id + '" src="' + getUrlFromPhoto(photo) + '" />');
	        });
	        // loadHqImages();
	      };
	      ...
	      fetch('/api/collections/' + id).then(function (response) {
	        return response.json();
	      }).then(function (response) {
	        return addImage(response);
	      });
	    });
	  }
	});
	...
	$(function () {
	  ...
	  if ($('.detailWrap').length > 0) {
	    ...
	    $('.detailWrap .inner').imagesLoaded(function () {
	      var msnry = new _masonryLayout2.default('.masonry', {
	        // options...
	  ...
	  if ($('.grid-wrapper').length > 0) {
	    ...
	    $('.grid-wrapper').imagesLoaded(function () {
	      var msnry = new _masonryLayout2.default('.grid-wrapper', {
	        // options...
	        // percentPosition: true,
	...
	var loadMoreCollections = function loadMoreCollections(offset) {
	  return fetch('/api/collections?offset=' + offset).then(function (response) {
	    return response.json();
	  });
	};

	var getCollectionWrap = function getCollectionWrap(item) {
	...
	// Infinte scroll
	$(function () {
	  var $theContainer = $('.collections');

	  var sr = ScrollReveal({ delay: 1000 });
	  ...
	  var onScroll = function onScroll() {
	    ...
	    if ($window.scrollTop() >= $theContainer.height() - $window.height() - tweak && !loadingCollections) {
	      ...
	      loadMoreCollections($('.collection-wrap').length).then(function (response) {

	        response.items.forEach(function (item, i) {
	          setTimeout(function () {
	            var html = getCollectionWrap(item);
